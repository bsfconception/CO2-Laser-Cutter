 ...
 *
 * Applies to the following boards: BSF adjustement
 *
...
//
  ...
  #endif
  #ifndef X_MAX_PIN
    #define X_MAX_PIN                          25   // 2 //BSF : replace pin by an unsused ext pin
  #endif
#endif
#ifndef Y_STOP_PIN
  #ifndef Y_MIN_PIN
  ...
  #endif
  #ifndef Y_MAX_PIN
    #define Y_MAX_PIN                         27    // 15 //BSF : replace pin by an unsused ext pin
  #endif
#endif
 //BSF - change the Z End stop because the pin are used by Serial2
#ifndef Z_STOP_PIN
  #ifndef Z_MIN_PIN
    #define Z_MIN_PIN                         2   //  18 use X Max Stop for Z Min Stop (
  #endif
  #ifndef Z_MAX_PIN
    #define Z_MAX_PIN                         29    // 19 //BSF : replace pin by an unsused ext pin
  #endif
#endif
...
#ifndef I_STOP_PIN
  #ifndef I_MIN_PIN
    #define I_MIN_PIN                         14  // use the same as Y
  #endif
#endif
//BSF
...
//////////////////////////
  ...
  //
      ...
      #else
        #define BTN_EN1              EXP1_02_PIN             //EXP1_01_PIN         //NSF
        #define BTN_EN2              EXP1_01_PIN             //EXP1_02_PIN         //NSF
        #define BTN_ENC              EXP2_03_PIN
      #endif
