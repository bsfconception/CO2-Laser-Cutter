...
/* LISTE OF Modifications and Features 
BSF Conception, modifications
3 axes
double moteur Y sur E0
Customisation End Stop Min
second port serie
Gestion rotational 'A' sur E1

09/11 : purge des fichers de config pour suppression des paramètres défitivements non utilsés
