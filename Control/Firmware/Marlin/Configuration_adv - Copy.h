...
//  #define COOLER_FAN                  // Enable a fan on the cooler, Fan# 0,1,2,3 etc. //BSF
...
#define HOMING_BUMP_MM      { 5, 5/*, 2*/ }       // (linear=mm, rotational=°) Backoff from endstops after first bump //BSF
#define HOMING_BUMP_DIVISOR { 2, 2 /*, 4*/ }       // Re-Bump Speed Divisor (Divides the Homing Feedrate) //BSF
...
#define AXIS_RELATIVE_MODES { false, false, false } //BSF
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 50*60, 50*60 /*,4*60 , 2*60 */} // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel //BSF
...
#define LASER_FEATURE   //BSF
  ...
  #define SPINDLE_LASER_USE_PWM                // Enable if your controller supports setting the speed/power
    ...
    #define SPINDLE_LASER_FREQUENCY     20000   // (Hz) Spindle/laser frequency (only on supported HALs: AVR, ESP32, and LPC) //BSF
